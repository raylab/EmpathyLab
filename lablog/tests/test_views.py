...
from lablog.models import Author
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self): 
        resp = self.client.get('/lablog/authors/') 
    ...
    def test_view_uses_correct_template(self):
        resp = self.client.get(reverse('authors'))
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, 'lablog/author_list.html')
...
from lablog.models import BookInstance, Book, Genre, Language
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(resp, '/accounts/login/?next=/lablog/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'lablog/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        #Check we used correct template
        self.assertTemplateUsed(resp, 'lablog/book_renew_librarian.html')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(resp, '/accounts/login/?next=/lablog/author/create/' )
    ...
    def test_uses_correct_template(self):
        ...
        resp = self.client.get(reverse('author_create') )
        self.assertEqual( resp.status_code,200)
        self.assertTemplateUsed(resp, 'lablog/author_form.html')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        self.assertEqual( resp.status_code,302)
        self.assertTrue( resp.url.startswith('/lablog/author/') )
